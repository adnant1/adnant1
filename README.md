...
I'm a **Computer Science student at The Ohio State University** primarily focused on **backend development**. I aim to build efficient, reliable systems that power large scale AI applications to solve real-world problems.
  
---

## 💻 Featured Projects

- [**StreamCache**](https://github.com/adnant1/streamcache) – A high-performance, log-backed, TTL-aware hybrid in-memory cache and streaming log engine for real-time and analytical workloads.
